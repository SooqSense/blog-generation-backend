...
EXPOSE 8000
RUN pip install gunicorn
CMD ["sh", "-c", "python management_app/manage.py migrate && gunicorn --bind 0.0.0.0:8000 --workers 2 --timeout 600 --threads 2 config.wsgi:application --chdir management_app"] 